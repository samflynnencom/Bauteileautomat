...
extern const ti_sysbios_knl_Semaphore_Handle handleCom;

#include <ti/sysbios/knl/Task.h>
extern const ti_sysbios_knl_Task_Handle handleUartRXTask;

#include <ti/sysbios/knl/Semaphore.h>
extern const ti_sysbios_knl_Semaphore_Handle sem_uart_rxdone;
